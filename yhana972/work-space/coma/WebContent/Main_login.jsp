...
<!DOCTYPE html>
<html lang="ko">
<head><!-- 로그아웃 버튼과 회원이름, 창 6개 -->
    <link href="css/coma.css" rel="stylesheet" type="text/css">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script>
</head>
<body>
    <div class="header">
        <a class="line1" href="boardAccount.jsp" ><%=u_nickname %> <span>님</span></a>
        <a class="line1" href="Main_logout.jsp">Logout</a></div>
    <table class="main">
        ...
        <td id="course">
            ...
            <div class="card">
             ...
             <div class="card">
                   ...
                   <div class="name_card">
                       <img  class="" src="img/main/picture04.jpg" >
                       <strong id="name">닉네임닉네임닏네임</strong>
                   </div>
                </div>
                 <!--하나의창-->
