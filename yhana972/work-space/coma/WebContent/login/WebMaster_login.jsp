...
<body>
	<div class="top">
		<header>
			<div>
				<nav class="left_nav1">
					<ul class="topmenu">
						<li id="to_home"><a class="mainline" href="Main_login.jsp?u_email=<%=u_email%>">COMA</a></li>
							...
							<div id="mycontent_submenu" class="submenu layerbox" style="display:none;">
								...
								<table>
									<thead>
										<tr>
											<th class="course">
												<span class="inner">코스</span>
												<div class="controls">
													<a class="setting" href="">설정</a>
													<a class="add" href="">추가</a>
												</div>
											</th>
											<th class="module">
												<span class="inner">모듈</span>
												<div class="controls">
													<a class="setting" href="">설정</a>
													<a class="add" href="">추가</a>
												</div>
		...
		<div id="act_submenu" class="submenu layerbox" style="display: none;">
			...
			<table>
				<thead>
					<tr>
						<th class="study">
							<span class="inner">공동공부</span>
						</th>
						<th class=marking>
							<span class="inner">봤어요</span>
							<span class="subtitle">
								누적봤어요 <span class="count">1</span>번
							</span>
						</th>
					</tr>
				</thead>
	...
	<div class="title_main">
		<p class="title1"><a href="WebMaster_login.jsp?u_email=<%=u_email%>">웹 마스터 1</a></p><!-- 줄간격 해야함 -->
	...
	<nav class="main_nav1 menubar">
		<div class="course2">
			<ul class="topmenu1">
				<li id="course1-1">
					<div class="label">
						<a class=" line3" href="WebMasterSide_login.jsp?u_email=<%=u_email%>">프론트엔드 1-1</a>
					</div>
