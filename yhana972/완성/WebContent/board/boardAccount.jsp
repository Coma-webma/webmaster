...
<%
	...
	String u_email = "deboner972@gmail.com";
...
<script type="text/javascript" src="../js/AccountCheck.js"></script>
<meta charset="UTF-8">
<title>계정설정</title>
</head>
<body>
	...
	<div id=contant>
		...
		<article>
			...
			<section>
				<form name="AccountForm" id="form" method="POST"
					action="boardAccountCheck.jsp?u_email=<%=u_email%>"
					onsubmit="return AccountCheck();">
					<div class="edit_box">
						<dl>
							<dt>이메일</dt>
							<dd><%=u_email%></dd>
						...
						<dl>
							...
							<dd>
								<!--사용자가 입력한 비밀번호와 디비 정보가 같지 않을 경우 -->
								<%if ("false".equals(check))%><script>window.alert("현재 비밀번호가 맞지 않습니다. 다시 입력해주세요.");</script>
						...
						<dl>
							...
							<dd>
								<input type="password" name="u_Repwd">
							</dd>
						</dl>
						<dl>
							<dt>
							...
							<dd>
								<input type="password" name="u_Repwd_check">
							</dd>
						</dl>
						<dl>
							<dt>
							...
							<dd>
								<textarea name="u_info"><%=rs.getString("u_info")%></textarea>
							</dd>
						</dl>
						<dl>
							<dt>
					...
					<div class="btn_select">
						<div class="btn_select2">
							<button type="submit" name="submit" class="btn save">저장</button>
						</div>
					</div>
				</form>
			</section>
