...
<body>
						...
						<li id="course1-1">
							...
							<div id="1" class="sub_nav depth_1"
								...
								<ul class="sub_nav">
									<li>
										<div class="label">
											<a href="WebMasterSide_login.jsp?u_email=<%=u_email%>">HTML 1-1-1</a>
										</div>
	...
	<div class="dir">
		<div class="dir_main">
			<span id="breadcrumb_line"> WebMaster <span class="divider">></span>
				프론트엔드 1-1 <span class="divider">></span> 커버페이지
			</span>
			<div class="dir_main_img">
				<img src="../img/dasktop/study_check_off.png">
				<div class="dir_main_right">
					<a href="#popup_together">공동공부 <small> ( <span
							class="count">50000</span> 명)
					</small>
					</a>
				</div>
			</div>
						...
						<div class="side_nav_list_name1">
							...
							<ul>
								<li class="side_nav_list2">
									<div class="side_nav_list_name2">닉네임</div>
									<div class="side_nav_list2_statics">토픽 2918 &nbsp;/&nbsp;
										봤어요 319</div> <script>
											$(function() {
												$(".left_side_title >").click(
														function() {
															$(this).addClass(
																	"select")
														});
		...
		<div class="content">
			...
			<div class="revious_next">
				<div class="revious_next_right">
					<div class="see">
						<a class="marking2" href="#"> <span class="action">봤어요</span>
							( <span class="count">11</span> 명)
	...
	<!--공동 공부 팝업-->
	<div class="popup" id="popup_together"
		style="width: 980px; height: 500px; left: 20%; display: none;">
		<div class="wrapper">
			<div class="header">
				<strong>공동공부</strong>
			</div>
			<div class="body">
				<div class="study_bar" style="width: 180px; height: 450px;">
					<ul style="padding-top: 12.5px; padding-bottom: 12.5px;">
						<li style="height: 25px;"><span class="cell"> <a
								class="cell" href>수업의 목적</a>
						</span></li>
						<li style="height: 25px;"><span class="cell"> <a
								class="cell" href>이렇게 쓰자</a>
						</span></li>
					</ul>
				</div>
				<div class="graph" style="width: 640px; height: 450px;">
					<div class="graph_wrap">
						<svg height="800" version="1.1" width="12100"
							...
							<!--가로줄-->
							<path fill="none" stroke="#dddddd" d="M0,0L12100,0"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,25L12100,25"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,50L12100,50"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,50L12100,50"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,75L12100,75"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,100L12100,100"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,125L12100,125"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,150L12100,150"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,175L12100,175"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,200L12100,200"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,225L12100,225"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,250L12100,250"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,275L12100,275"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,300L12100,300"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,325L12100,325"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,350L12100,350"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,375L12100,375"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,400L12100,400"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,425L12100,425"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<path fill="none" stroke="#dddddd" d="M0,450L12100,450"
								stroke-dasharray="3,1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></path>
							<!--세로줄(rect), 원(circle)-->
							<rect x="60" y="0" width="0.5" height="800" r="0" rx="0" ry="0"
								fill="#dcdcdc" stroke="#000" stroke-width="0"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></rect>

							<rect x="120" y="0" width="0.5" height="800" r="0" rx="0" ry="0"
								fill="#dcdcdc" stroke="#000" stroke-width="0"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
							</rect>
							<circle cx="120" cy="25" r="5" fill="#93c8e0" stroke="#93c8e0"
								stroke-width="1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
							<rect x="180" y="0" width="0.5" height="800" r="0" rx="0" ry="0"
								fill="#dcdcdc" stroke="#000" stroke-width="0"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
							</rect>
							<circle cx="180" cy="25" r="5" fill="#93c8e0" stroke="#93c8e0"
								stroke-width="1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
							<circle cx="180" cy="50" r="5" fill="#93c8e0" stroke="#93c8e0"
								stroke-width="1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
							<rect x="240" y="0" width="0.5" height="800" r="0" rx="0" ry="0"
								fill="#dcdcdc" stroke="#000" stroke-width="0"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
							</rect>
							<circle cx="240" cy="50" r="5" fill="#93c8e0" stroke="#93c8e0"
								stroke-width="1"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></circle>
							<rect x="300" y="0" width="0.5" height="800" r="0" rx="0" ry="0"
								fill="#dcdcdc" stroke="#000" stroke-width="0"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
							</rect>
							<rect x="360" y="0" width="0.5" height="800" r="0" rx="0" ry="0"
								fill="#dcdcdc" stroke="#000" stroke-width="0"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
							</rect>
							<rect x="420" y="0" width="0.5" height="800" r="0" rx="0" ry="0"
								fill="#dcdcdc" stroke="#000" stroke-width="0"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
							</rect>
							<rect x="480" y="0" width="0.5" height="800" r="0" rx="0" ry="0"
								fill="#dcdcdc" stroke="#000" stroke-width="0"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
							</rect>
							<rect x="540" y="0" width="0.5" height="800" r="0" rx="0" ry="0"
								fill="#dcdcdc" stroke="#000" stroke-width="0"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
							</rect>
							<rect x="600" y="0" width="0.5" height="800" r="0" rx="0" ry="0"
								fill="#dcdcdc" stroke="#000" stroke-width="0"
								style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
							</rect>
						</svg>
				...
				<div class="x_bar" style="width: 460;">
					<ul>
						...
						<li style="width: 55px;"><strong>You</strong></li>
						<!--변경-->
				...
				<div class="goodjob_guys" style="width: 159px">
					<Strong class="title">명예의 전당 <span class="count">(324)</span>
					</Strong>
					<div class="good_wrap" style="height: 406px;">
						<ul>
							<li><img class="user_pic" src="../img/user_pic.png" width="32"
								height="32" alt> <strong>기현</strong> <small><time>2019-10-31
										17:41:30 </time></small></li>
							<li><img class="user_pic" src="../img/user_pic.png" width="32"
								height="32" alt> <strong>나현</strong> <small><time>2019-10-31
										17:50:20 </time></small></li>
							<li><img class="user_pic" src="../img/user_pic.png" width="32"
								height="32" alt> <strong>태경</strong> <small><time>2019-10-31
										17:51:20 </time></small></li>
							<li><img class="user_pic" src="../img/user_pic.png" width="32"
								height="32" alt> <strong>수빈</strong> <small><time>2019-10-31
										17:51:28 </time></small></li>
							<li><img class="user_pic" src="../img/user_pic.png" width="32"
								height="32" alt> <strong>유하</strong> <small><time>2019-10-31
										17:52:02 </time></small></li>
							<li><img class="user_pic" src="../img/user_pic.png" width="32"
								height="32" alt> <strong>찬성</strong> <small><time>2019-10-31
										17:52:55 </time></small></li>
						</ul>
					</div>
				</div>
			</div>
