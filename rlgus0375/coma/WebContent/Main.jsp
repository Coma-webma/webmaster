...
<body>
	<div class="header">
		<a class="line1" href=#>Login</a>
		<a class="line1" href="BoardAccount.jsp">회원수정</a>
	</div>
	<table class="main">
		...
		<tr>
			<td id="search">
				<input type="text" maxlength="90" placeholder="   검색 혹은 입력">
			</td>
		</tr>
		<tr>
			<td height="40"></td>
		...
		<tr>
			<td id="course">
				...
				<div class="card">
					...
					<div class="name_card">
						<img class="" src="" width="45px" height="45px"> <strong id="name">닉네임닉네임닏네임</strong>
					</div>
				</div>
				<!--하나의창(추가시 이거가지고가기-->
				<!--하나의창-->
