			...
			<fieldset id="functions">
				<ul>
					...
					<li><input type="radio" id="function_topic" name="function"
						value="topic"> <label for="function_topic"><a href="../topic/boardtopicmain.jsp?m_idx=<%=m_idx%>" style="color: black">토픽목록</a></label></li>
				</ul>
			</fieldset>
			<hgroup id="img1">

				<h2><%=rs.getString("m_title")%></h2>
			</hgroup>
			<section>
				<form name=boardmoduleForm method="post"
					action="boardmodulemodify_ok.jsp?m_idx=<%=rs.getString("m_idx")%>"
					...
					<div class="btn_select">
						<div class="btn_select2">
							...
							<button type="button" class="btn save"
								OnClick="window.location='../boardDell.jsp?idx=<%=rs.getString("m_idx")%>&idx_dell=module'">삭제</button>
						</div>
